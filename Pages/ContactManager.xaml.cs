...
namespace upgrade_blank.Pages
{
  internal class ContactManagerSidebarLabel : ISidebarLabel
  {
    ...
    {
      get { return upgrade_blank.Properties.Resources.CFG_LBL_CONTACT_MGR; }
    }    
  }
  /// <summary>
  ...
  internal partial class MTK_ContactManager : EditorPage
  {
    ...
    public void OnUnCheck(object sender, RoutedEventArgs e)
    {
      ...
      if (false == check && "external".Equals(tagNode.InnerText))
      {
        ...
        // show dialog
        MessageBoxResult result = ArcGIS.Desktop.Internal.Framework.DialogManager.ShowMessageBox(upgrade_blank.Properties.Resources.LBL_CM_Confirm, upgrade_blank.Properties.Resources.LBL_CM_ConfirmTitle, button, icon);
