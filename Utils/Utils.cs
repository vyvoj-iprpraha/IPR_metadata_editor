  ...
  public static IEnumerable<XmlNode> GetXmlDataContext(object dataContext)
    ...
    public static string GetResString(string key)
    {
      if (null == _resourceManager)
        _resourceManager = new ResourceManager("upgrade_blank.Properties.Resources", System.Reflection.Assembly.GetExecutingAssembly());
    ...
    static public String ExtractResponsiblePartyLabel(XmlNode root, string format)
    {
      ...
      var roleLabel = upgrade_blank.Properties.Resources.LBL_CI_PARTY_ROLE_UNKNOWN;
